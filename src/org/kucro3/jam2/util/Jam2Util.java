...
public final class Jam2Util extends ClassLoader implements Opcodes {
	...
	public static void pushNewInstance(ClassVisitor cw, int modifiers, String methodName,
			Constructor<?> constructor, boolean varags, boolean objReturn)
	{
		pushNewInstance(cw, modifiers, methodName,
				constructor.getDeclaringClass(), constructor.getParameterTypes(), constructor.getExceptionTypes(),
				varags, objReturn);
	}
	...
	public static void pushFieldGetter(ClassVisitor cw, int modifiers, String name,
									   Field field, boolean objArg, boolean objReturn)
	{
		pushFieldGetter(cw, modifiers, name,
				Objects.requireNonNull(field.getDeclaringClass(), "Declaring class needed"), field.getName(), field.getType(),
				FieldType.fromModifier(field.getModifiers()), objArg, objReturn);
	}
	...
	public static void pushFieldSetter(ClassVisitor cw, int modifiers, String name,
			Field field, boolean objArgument)
	{
		pushFieldSetter(cw, modifiers, name,
				field.getDeclaringClass(), field.getName(), field.getType(),
				FieldType.fromModifier(field.getModifiers()), objArgument);
	}
	...
	public static void pushGetter(ClassVisitor cw, int modifiers, String name, Field field)
	{
		pushGetter(cw, modifiers, name,
                field.getDeclaringClass(), field.getName(), field.getType(), FieldType.fromModifier(field.getModifiers()));
	}

    public static void pushGetter(ClassVisitor cw, int modifiers, String name,
                                  Class<?> ownerClass, String fieldName, Class<?> type, FieldType ft)
    {
        pushGetter(cw, modifiers, name, toInternalName(ownerClass), fieldName, type, ft);
    }
	
	public static void pushGetter(ClassVisitor cw, int modifiers, String name,
                                  String ownerInternalName, String fieldName, Class<?> type, FieldType ft)
	{
		pushGetter(cw, modifiers, name, ownerInternalName, fieldName, Type.getDescriptor(type), ft);
	}
	
	public static void pushGetter(ClassVisitor cw, int modifiers, String name,
                                  String ownerInternalName, String fieldname, String type, FieldType ft)
	{
	...
	public static void pushSetter(ClassVisitor cw, int modifiers, String name, Field field)
	{
		pushSetter(cw, modifiers, name,
                field.getDeclaringClass(), field.getName(), field.getType(), FieldType.fromModifier(field.getModifiers()));
	}

    public static void pushSetter(ClassVisitor cw, int modifiers, String name,
                                  Class<?> ownerClass, String fieldName, Class<?> type, FieldType ft)
    {
        pushSetter(cw, modifiers, name, toInternalName(ownerClass), fieldName, type, ft);
    }
	
	public static void pushSetter(ClassVisitor cw, int modifiers, String name,
                                  String ownerInternalName, String fieldName, Class<?> type, FieldType ft)
	{
		pushSetter(cw, modifiers, name, ownerInternalName, fieldName, Type.getDescriptor(type), ft);
	}
	...
	public static void pushJavaBean(ClassVisitor cw, Field field)
	{
		pushJavaBean(cw, field.getDeclaringClass(), field.getName(), field.getType());
	}

    public static void pushJavaBean(ClassVisitor cw, Class<?> ownerClass, String fieldName, Class<?> type)
    {
        pushJavaBean(cw, toInternalName(ownerClass), fieldName, type);
    }
	...
	public static void pushCaller(ClassVisitor cw, int modifiers, String name, Method method, CallingType ct,
                                  boolean vargs, boolean objReturn)
	{
		pushCaller(cw, modifiers, name,
				method.getDeclaringClass(), method.getName(), method.getReturnType(),
				method.getParameterTypes(), ct, vargs, objReturn);
	}
